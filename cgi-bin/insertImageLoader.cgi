...
#
# Description: Questo script verifica che l'utente sia autenticato e visualizza il template della pagina di inserimento di una nuova immagine
#
...
$template = HTML::Template->new(filename => 'insertImage.tmpl'); # raccolgo il file di template
